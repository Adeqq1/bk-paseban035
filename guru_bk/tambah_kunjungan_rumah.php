...
if (isset($_POST['simpan'])) {
    ...
    // Opsional: Update alamat di data siswa jika diisi
    if (!empty($alamat)) {
        mysqli_query($koneksi, "UPDATE siswa SET alamat = '$alamat' WHERE id = '$siswa_id'");
    }

    $query_insert = "INSERT INTO kunjungan_rumah 
                     (nomor_urut, siswa_id, guru_id, tanggal_pelaksanaan, nama_ortu, alamat, yang_ditemui, permasalahan, tujuan_home_visit, hasil_home_visit) 
                     VALUES 
                     ('$nomor_urut', '$siswa_id', '$guru_id', '$tanggal_pelaksanaan', '$nama_ortu', '$alamat', '$yang_ditemui', '$permasalahan', '$tujuan_home_visit', '$hasil_home_visit')";
    
    if (mysqli_query($koneksi, $query_insert)) {
        header("Location: kunjungan_rumah.php?pesan=success_tambah");
        exit();
    } else {
        $error = "Gagal menyimpan Laporan Kunjungan Rumah: " . mysqli_error($koneksi);
    }
}
?>
<!DOCTYPE html>
...
<head>
    ...
    <title>Buat Laporan Home Visit | BK SMA 07 Bungo</title>
...
<body>
    ...
    <div class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <li><a href="buku_kasus.php"><i class="fas fa-book"></i> Buku Catatan Kasus</a></li>
    ...
    <div class="main-content">
        <div class="header" style="background: linear-gradient(135deg, #1e293b 0%, #0f172a 100%); padding: 2rem; border-radius: 16px; margin-bottom: 2rem; color: white; display: flex; align-items: center; justify-content: space-between; flex-wrap: wrap; gap: 1.5rem; box-shadow: 0 10px 25px -5px rgba(0, 0, 0, 0.3);">
            <div style="display: flex; align-items: center; gap: 1.5rem;">
                ...
                <div>
                    <h1 style="margin: 0 0 6px 0; font-size: 1.6rem; font-weight: 800; color: white;">Buat Laporan <span style="color: #38bdf8;">Kunjungan Rumah (Home Visit)</span></h1>
                    <p style="margin: 0; color: #94a3b8; font-size: 0.925rem;">Formulir Resmi Dokumentasi Kunjungan Rumah Konseli</p>
                </div>
            </div>
        </div>
                ...
                <div class="form-grid-layout">
                    <div>
                        ...
                        <div style="background: #f0fdf4; padding: 1.25rem; border-radius: 8px; border: 1px solid #bbf7d0; margin-bottom: 1.5rem;">
                            ...
                            <div style="margin-bottom: 1rem;">
                                ...
                                <input type="text" name="alamat" id="alamat" class="form-control" style="width: 100%; padding: 0.7rem 1rem; border-radius: 8px; border: 1px solid #cbd5e1; background: #fff;" placeholder="Contoh: Jln. Lintas Sumatera, Tanah Abang" required>
                            </div>
                            ...
                            <div style="margin-bottom: 1rem;">
                                ...
                                <input type="text" name="nama_ortu" id="nama_ortu" class="form-control" style="width: 100%; padding: 0.7rem 1rem; border-radius: 8px; border: 1px solid #cbd5e1; background: #fff;" placeholder="Contoh: Kasmi Dewi" required>
                            </div>
                        </div>
                        ...
                        <div style="background: #f0f9ff; padding: 1.25rem; border-radius: 8px; border: 1px solid #bae6fd; margin-bottom: 1.5rem;">
                            ...
                            <div style="margin-bottom: 1rem;">
                                ...
                                <input type="date" name="tanggal_pelaksanaan" id="tanggal_pelaksanaan" class="form-control" style="width: 100%; padding: 0.7rem 1rem; border-radius: 8px; border: 1px solid #cbd5e1; background: #fff;" value="<?php echo date('Y-m-d'); ?>" required>
                            </div>
                            ...
                            <div>
                                ...
                                <input type="text" name="yang_ditemui" id="yang_ditemui" class="form-control" style="width: 100%; padding: 0.7rem 1rem; border-radius: 8px; border: 1px solid #cbd5e1; background: #fff;" placeholder="Contoh: Ortu Konseli (Bapak dan Ibu)" required>
                            </div>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div style="margin-bottom: 1.5rem;">
                            ...
                            <textarea name="permasalahan" id="permasalahan" class="form-control" rows="4" style="width: 100%; padding: 0.75rem 1rem; border-radius: 8px; border: 1px solid #cbd5e1; background-color: #f8fafc;" placeholder="Konseli sering tidak masuk, dengan alasan tidak mampu melunasi uang sekolah, sedangkan orang tua tidak bisa memenuhi surat panggilan ortu..." required></textarea>
                        </div>
                        ...
                        <div style="margin-bottom: 1.5rem;">
                            ...
                            <textarea name="tujuan_home_visit" id="tujuan_home_visit" class="form-control" rows="4" style="width: 100%; padding: 0.75rem 1rem; border-radius: 8px; border: 1px solid #cbd5e1; background-color: #f8fafc;" placeholder="1. Laporan pada orang tua tentang belajar konseli di sekolah.&#10;2. Klarifikasi dg orang tua tentang siswa tidak ingin sekolah lagi.&#10;3. Pembahasan masalah konseli." required>1. Laporan pada orang tua tentang belajar konseli di sekolah.
2. Klarifikasi dg orang tua tentang siswa tidak ingin sekolah lagi.
3. Pembahasan masalah konseli.</textarea>
                        </div>
                    </div>
                    ...
                    <div class="full-width-col" style="margin-bottom: 1.5rem;">
                        ...
                        <textarea name="hasil_home_visit" id="hasil_home_visit" class="form-control" rows="4" style="width: 100%; padding: 0.75rem 1rem; border-radius: 8px; border: 1px solid #cbd5e1; background-color: #f8fafc;" placeholder="Orang tua berkeinginan anak tetap bersekolah, masalah biaya sekolah akan berusaha melunasi nya, dan akan tetap bersekolah di SMAN 7 Bungo." required></textarea>
                    </div>
                </div>
